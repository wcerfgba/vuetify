// Styles
import "../../../src/components/VFileInput/VFileInput.sass"; // Components

import { VChip } from '../VChip';
import { VTextField } from '../VTextField'; // Utilities
...
export default VTextField.extend({
  ...
  methods: {
    ...
    genInput() {
      const listeners = Object.assign({}, this.$listeners); // delete listeners['change'] // Change should not be bound externally
